    ...
    <div>
        <div className="dash-right-content" style={{paddingRight: "28px"}}>
            <div className="dash-graph">
                <LineChart min={0}  xdata={this.state.sgpa} xaxis={['Sem 1','Sem 2','Sem 3','Sem 4','Sem 5','Sem 6','Sem 7','Sem 8']} color={"#5995fd"} hover={"#3C64AB"} label={"Grade (SGPA)"} />
            </div>
            <div className="dash-graph">
                <LineChart min={0}  xdata={this.state.hrs} xaxis={['Sem 1','Sem 2','Sem 3','Sem 4','Sem 5','Sem 6','Sem 7','Sem 8']} color={"#e84545"} hover={"#ac0d0d"} label={"No. of Leave"} />
            </div>
        </div>
