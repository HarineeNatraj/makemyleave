...
accept=(id,type,idd,date)=>{
    axios.post(`${process.env.REACT_APP_APILINK}/approve_leave`,{s_id:id,type:type,response:"accepted",id:idd,date:date.getDay()})
    .then(res=>{
this.componentDidMount();
    })

}
reject=(id,type,idd,date)=>{
    axios.post(`${process.env.REACT_APP_APILINK}/approve_leave`,{s_id:id,type:type,response:"rejected",id:idd,date:date.getDay()})
    .then(res=>{
        this.componentDidMount();

    })
}
pending=(id,type,idd,date)=>{
    axios.post(`${process.env.REACT_APP_APILINK}/approve_leave`,{s_id:id,type:type,response:"pending",id:idd,date:date.getDay()})
    .then(res=>{
        this.componentDidMount();
...
marginLeft: "140px"}}>
                   <div style={{flex:"0.3",display:"flex",justifyContent:"center"}}><button onClick={()=>{
                        this.accept(ob.s_id,"ml",ob.id,ob.from_date)
                    }}
                    ...
                    <div style={{flex:"0.3",display:"flex",justifyContent:"center"}}><button onClick={()=>{
                        this.reject(ob.s_id,"ml",ob.id,ob.from_date)
                    }}
                    ...
                    <div style={{flex:"0.3",display:"flex",justifyContent:"center"}}><button onClick={()=>{
                        this.pennding(ob.s_id,"ml",ob.id,ob.from_date)
                    }}
            ...
            <div
                ...
                <div style={{display:"flex",marginTop:"15px"}}>
                    <div style={{flex:0.5,display:"flex",justifyContent:"center"}}>
                        <h6>From : </h6>
                        <h6 style={{fontWeight:"300",textShadow: "0 0 3px #FF0000"}}>{ob.o_date}</h6>
                    </div>
                    <div style={{flex:"0.5",display:"flex",justifyContent:"center"}}>
                        <h6>From Time : </h6>
                        <h6 style={{fontWeight:"300",textShadow: "0 0 3px #FF0000"}}>{ob.from_time}</h6>
                    </div>
                    <div style={{flex:"0.5",display:"flex",justifyContent:"center"}}>
                        <h6>To Time : </h6>
                        <h6 style={{fontWeight:"300",textShadow: "0 0 3px #FF0000"}}>{ob.to_time}</h6>
                    </div>
                </div>
                <h6
                    style={{textAlign:"center",marginTop:"20px",fontSize:"25px",fontWeight:"400",textDecoration:"underline",padding:"3px"}}>
 ...
 marginLeft: "140px"}}>
                <div style={{flex:"0.3",display:"flex",justifyContent:"center"}}><button onClick={()=>{
                        this.accept(ob.s_id,"od",ob.id,ob.od_date)
                    }}
                            style={{flex:"0.3",height:"30px",width:"150px",color:"white",outline:"none",border:"none",borderRadius:"49px",backgroundColor:"#289672"}}>Accept</button>
                    </div>
                    <div style={{flex:"0.3",display:"flex",justifyContent:"center"}}><button onClick={()=>{
                        this.reject(ob.s_id,"od",ob.id,ob.od_date)
                    }}
                            style={{flex:"0.3",height:"30px",width:"150px",color:"white",outline:"none",border:"none",borderRadius:"49px",backgroundColor:"#be0000"}}>Reject</button>
                    </div>
                    <div style={{flex:"0.3",display:"flex",justifyContent:"center"}}><button onClick={()=>{
                        this.pennding(ob.s_id,"od",ob.id,ob.od_date)
                    }}
                            style={{flex:"0.3",height:"30px",width:"150px",color:"white",outline:"none",border:"none",borderRadius:"49px",backgroundColor:"#ffbe0f"}}>Accept</button>
                    </div>
                </div>
 ...
 marginLeft: "140px"}}>
                    <div style={{flex:"0.3",display:"flex",justifyContent:"center"}}><button onClick={()=>{
                        this.accept(ob.s_id,"ordinary",ob.id,ob.from_date)
                    }}
                            style={{flex:"0.3",height:"30px",width:"150px",color:"white",outline:"none",border:"none",borderRadius:"49px",backgroundColor:"#289672"}}>Accept</button>
                    </div>
                    <div style={{flex:"0.3",display:"flex",justifyContent:"center"}}><button onClick={()=>{
                        this.reject(ob.s_id,"ordinary",ob.id,ob.from_date)
                    }}
                            style={{flex:"0.3",height:"30px",width:"150px",color:"white",outline:"none",border:"none",borderRadius:"49px",backgroundColor:"#be0000"}}>Reject</button>
                    </div>
                    <div style={{flex:"0.3",display:"flex",justifyContent:"center"}}><button onClick={()=>{
                        this.pennding(ob.s_id,"ordinary",ob.id,ob.from_date)
                    }}
                            style={{flex:"0.3",height:"30px",width:"150px",color:"white",outline:"none",border:"none",borderRadius:"49px",backgroundColor:"#ffbe0f"}}>Accept</button>
                    </div>
                </div>
